...
export default function Hero() {
  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-green-900 via-green-800 to-green-950"
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        />
        {/* Зерновая текстура — тонкие линии */}
...
>
  <span className="relative inline-block">
    <span className="relative z-10 bg-gradient-to-r from-yellow-300 via-amber-300 to-yellow-200 bg-clip-text text-transparent">
      Прямые поставки
    </span>
  ...
  от производителя
          ...
          >
            Крупное сельхозпредприятие с собственными полями. Выращиваем,
            храним и доставляем продукцию оптовым покупателям по всей России.
          </motion.p>
          ...
          >
            <a
              href="#contact"
              className="px-8 py-4 bg-yellow-500 hover:bg-yellow-400 text-green-950 font-bold rounded-xl text-lg transition-all transform hover:scale-105 shadow-xl shadow-yellow-500/25 text-center"
            >
              Оставить заявку
            </a>
            <a
              href="#products"
              className="px-8 py-4 bg-white/10 hover:bg-white/20 text-white font-semibold rounded-xl text-lg backdrop-blur-sm border border-white/20 transition-all text-center"
            >
              Смотреть продукцию
            </a>
          </motion.div>
          ...
          >
            {[
              { value: "2 500+", label: "гектаров полей" },

...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        agro: { 50: '#f0fdf4', 100: '#dcfce7', 200: '#bbf7d0', 300: '#86efac', 400: '#4ade80', 500: '#22c55e', 600: '#16a34a', 700: '#15803d', 800: '#166534', 900: '#14532d', 950: '#052e16' },
        earth: { 50: '#fdf8f0', 100: '#f9eddb' },
        cream: '#fefce8',
        gold: { DEFAULT: '#d4a853', dark: '#b8922e', light: '#f0d78c' },
